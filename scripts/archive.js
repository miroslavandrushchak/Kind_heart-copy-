...
fifthProjectBlock = document.querySelector(".fifth_project");
...
fifthProjectTextBlock = document.querySelector(".fifth_project_text_block");
...
fifthProjectDescription = document.querySelector(".fifth_project_description");
...
kidPhoto5 = document.querySelector(".kid_photo_5");
...
fifthProjectHelpWays = document.querySelector(".fifth_project_help_ways");
...
document.addEventListener("click", (openProjectBlock) => {
    if (openProjectBlock.target === contentOpenButtonArray[0]) {
      ...
      fifthProjectBlock.classList.remove("active_fifth_project");
      fifthProjectDescription.classList.remove("active_fifth_project_description");
      kidPhoto5.classList.remove("active_kid_photo_5");
      fifthProjectTextBlock.classList.remove("active_fifth_project_text_block");
    }
    ...
    if (openProjectBlock.target === contentOpenButtonArray[4]) {
        currentProjects.classList.add("active_current_projects");
        fifthProjectHelpWays.classList.add("active_fifth_project_help_ways");
        fifthProjectBlock.classList.add("active_fifth_project");
        fifthProjectDescription.classList.add("active_fifth_project_description");
        kidPhoto5.classList.add("active_kid_photo_5");
        fifthProjectTextBlock.classList.add("active_fifth_project_text_block");
...
aArray.forEach(element => {
  element.addEventListener("click", () => {
    ...
    fifthProjectHelpWays.classList.remove("active_fifth_project_help_ways");
